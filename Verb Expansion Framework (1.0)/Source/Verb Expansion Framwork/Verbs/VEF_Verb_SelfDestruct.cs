...
{
    class VEF_Verb_SelfDestruct : VEF_Verb_Explode
    {
        protected override bool TryCastShot()
        {
            ...
            if (verbProps.burstShotCount < 2 || !Bursting)
            {
                Log.Message("Scheduling Caster to Die");
                Current.Game.GetComponent<VEF_GameComp_Slayer>().thingsToKill.Add(new VEF_KillInfo(this.caster, verbPropsExplode.explosionDamageType));
            }
            return true;
        }
