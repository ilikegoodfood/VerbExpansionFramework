...
{
    class VEF_Verb_ShootBody : Verb_Shoot
    {
        protected override bool TryCastShot()
        {
            ...
            if (this.CasterIsPawn)
            {
                ...
                VEF_ReflectionData.FI_Projectile_WeaponDamageMultiplier.SetValue(projectile2, weaponDamageMultiplier + ((this.caster.def.race.baseBodySize - 1) * 0.5));
            }
